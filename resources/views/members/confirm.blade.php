            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-body" style="height: 500px;">
                        <form method="POST" action="{{ route('members.complete') }}" class="p-5" enctype="multipart/form-data">
                            @csrf

                            <div class="form-group">
                                <label for="id"class="col-md-7 col-form-label text-md-right">{{ __('ID：') }} {{ __('登録後に自動発番') }}</label>
                            </div>    
