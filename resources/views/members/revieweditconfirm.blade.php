    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('members.revieweditcomplete') }}">
                        @csrf
                        
                        <div class="form-group">
                            <label for="product_content" class="col-md-12 col-form-label text-md-center">{{ __('商品ID：') }} {{ $update_id }}</label>
                        </div>
                        ...
                        <div class="form-group mb-0 mt-5" style="display:flex; justify-content:center;">
                            <button type="submit" class="btn btn-block btn-primary col-md-4">{{ __('編集完了') }}</button>
                        </div>
                        <input name="id" type="hidden" value="{{ $update_id }}">
