        ...
        <div class="col-md-10">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="font-weight-bold text-left" style="font-size: 24px">{{ __('商品登録') }}</div>
                        <div class="font-weight-bold text-right pb-3 pt-3" style="font-size: 12px">
                            <button type="button" class="btn btn-primary col-md-2" onclick="location.href='/admin/home'">{{ __('一覧へ戻る') }}</button>
                        </div>
                    </div>

                    <div class="card-body" style="height: 1600px;">
                        <form method="POST" action="{{ route('members.productconfirm') }}" class="p-5" enctype="multipart/form-data">
                            @csrf
